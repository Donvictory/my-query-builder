      ...
      <header className="sticky top-0 z-40 w-full backdrop-blur-md bg-background/80 border-b border-border/60 px-4 py-2.5">
        <div className="flex items-center justify-between w-full">
          ...
          <div className="hidden md:flex items-center gap-1.5">
            ...
            <div className="border-l border-border/80 pl-1.5 ml-1.5">
              <Button
                variant="ghost"
                size="icon"
                className="h-7 w-7 rounded-md hover:bg-muted text-muted-foreground hover:text-foreground"
          ...
          <div className="flex md:hidden items-center gap-1.5">
            ...
            <Button
              variant="outline"
              size="icon"
              className="h-7 w-7 rounded-md bg-background border-border/80 hover:bg-muted text-muted-foreground hover:text-foreground"
